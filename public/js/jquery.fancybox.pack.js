    ...
    f.extend(b, {
        ...
        defaults: {
            ...
            tpl: {
                ...
                closeBtn: '<a title="Close" class="fancybox-item fancybox-close" href="javascript:;" id="closePopUp" style="margin-right:40px;margin-top:30px;color:#000;text-decoration:none;text-transform:uppercase;font-size:12px;">Close</a>',
